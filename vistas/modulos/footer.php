		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 text-left infoContacto">
				...
				<h5>
					...
					<i class="fa fa-phone-square" aria-hidden="true"></i> (09)61202247
					...
					<i class="fa fa-map-marker" aria-hidden="true"></i> Calle San Isidro 154
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-6 col-xs-12 text-left text-muted">
				...
				<h5>&copy; 2020 Todos los derechos reservados.Desarrollado por María José Arancibia </h5>
